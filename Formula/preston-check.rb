...
class PrestonCheck < Formula
  ...
  url "https://github.com/preston-check/preston-check/releases/download/v1.7.9/preston-check-1.7.9.tar.gz"
  sha256 "dfcb010071e87e527e65fbc07ecbadfc903baf07b0b07c070bc632b57288e55d"
  license "Apache-2.0"
  version "1.7.9"
