...
class PrestonCheck < Formula
  ...
  url "https://github.com/preston-check/preston-check/releases/download/v1.7.8/preston-check-1.7.8.tar.gz"
  sha256 "2a88efbecab28eefe0cab463c2dc0ffb0b013b3a660b7fb2d2f5ca6abc50e81c"
  license "Apache-2.0"
  version "1.7.8"
