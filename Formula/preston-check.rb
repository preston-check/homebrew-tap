...
class PrestonCheck < Formula
  ...
  url "https://github.com/preston-check/preston-check/releases/download/v1.7.6/preston-check-1.7.6.tar.gz"
  sha256 "35cf62e1b2b5ff36312ced486f0fd9b6e0483d6e6f52e5069b6e2ed6db4977ca"
  license "Apache-2.0"
  version "1.7.6"
